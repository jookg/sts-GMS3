            ...
            <div class="row">
                <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                  <div class="thumbnail text-center photo_view_postion_b" >
                    <img src="${path.img}/${student.profile}" alt="stack photo" class="img">
                  </div>
                </div>
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      <h2>&nbsp;<span id="pname">${requestScope.student.name}</span>&nbsp;&nbsp; <button id="updateBtn" >정보수정</button></h2>
                     
                    </div>
                      <hr>
                    <div class="col-md-8">  
                    <ul class=" details">
                      <li><p id="pphone"><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span>${requestScope.student.phone}</p></li>
                      <li><p id="pemail"><span class="glyphicon glyphicon-envelope one" style="width:50px;"></span>${requestScope.student.email}</p></li>
                      <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>${requestScope.student.regdate}</p></li>
                    ...
                    <div class="col-md-4">  
                      ...
                      <div class="col-sm-5 col-xs-6 tital " >No:</div><div class="col-sm-7 col-xs-6 ">${requestScope.student.no}</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
                      <div class="col-sm-5 col-xs-6 tital " >ID:</div><div id="pid" class="col-sm-7 col-xs-6 ">${requestScope.student.id}</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
                    </div>
                </div>
              </div>
